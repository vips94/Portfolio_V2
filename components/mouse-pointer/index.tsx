...
function useEventListener(eventName:any, handler:any, element = document) {
  const savedHandler = React.useRef() as any
...
function AnimatedCursor({
  ...
  const cursorOuterRef = React.useRef() as any;
  const cursorInnerRef = React.useRef() as any;
  ...
  const onMouseMove = React.useCallback(({ clientX, clientY }:any) => {
